...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		//Servidor(maxConexiones, buffer[en bytes], tamaño paquetes, minutos conexión inactiva, importancia baja conexion, importancia baja latencia, importancia alto ancho banda)
